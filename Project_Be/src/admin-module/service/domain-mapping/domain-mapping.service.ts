...
export class DomainMappingService extends BaseEntityService {
     ...
     * @param {*} secondId 
     */
    join(firstDomain: string, firstId: string, secondDomain: string, secondId: string): Promise<any> {
     ...
     * @param {*} secondIds 
     */
    async joinMulti(firstDomain: string, firstId: string, secondDomain: string, secondIds: string[]): Promise<any> {
        return new Promise((resolve, reject) => {
            ...
            this.entityRepository.find({
                ...
                limit(secondIds, (secondId: any) => {
                    let key: string = `domain_mapping:${firstDomain}:${firstId}:${secondDomain}:${secondId}`
