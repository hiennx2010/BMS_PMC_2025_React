...
```
cd existing_repo
git remote add origin http://10.100.20.66/itkbs/nestjs-common-module.git
git branch -M main
...
- [ ] [Set up project integrations](http://10.100.20.66/itkbs/nestjs-common-module/-/settings/integrations)
