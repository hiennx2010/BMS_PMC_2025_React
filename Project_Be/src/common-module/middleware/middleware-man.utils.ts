...
export class MiddlewareManUtils {
  ...
  static registerMiddleware(middleware: IMiddlewareDetails) {
    ...
    MiddlewareManUtils.__middlewares = MiddlewareManUtils.__middlewares.sort(
      (a: IMiddlewareDetails, b: IMiddlewareDetails) => {
        return (
          (a.ord || MiddlewareManUtils.DEFAULT_ORD) -
          (b.ord || MiddlewareManUtils.DEFAULT_ORD)
        );
      },
    );
  }
